...
# AUTHOR: Omar Jaber
# FILENAME: cnn.py
# SPECIFICATION: CNN that uses tensorflow and keras to recognize hand-written digits
...
def load_digit_images_from_folder(folder_path, image_size=(32, 32)):
    ...
    for filename in os.listdir(folder_path):
        ...
        y.append(label)
    return np.array(X).astype('int64'), np.array(y).astype('int64')
...
model = models.Sequential([
    ...
    # --> add your Python code here
    layers.Conv2D(filters=32, kernel_size=(3, 3), input_shape=(32, 32, 1), activation='relu'),
